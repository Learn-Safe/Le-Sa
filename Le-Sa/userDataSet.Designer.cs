...
namespace Le_Sa.userDataSetTableAdapters {
    ...
    public partial class tbl_userTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[tbl_user] WHERE (([username] = @Original_username) AND ((@IsNu" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[tbl_user] SET [username] = @username, [password] = @password WHERE (([username] = @Original_username) AND ((@IsNull_password = 1 AND [password] IS NULL) OR ([password] = @Original_password)));
SELECT username, password FROM tbl_user WHERE (username = @username)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Le_Sa.Properties.Settings.Default.conUser;
        }
